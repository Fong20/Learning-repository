...
## Generating Interface IDs for GUA
  ...
  - EUI-64 method provides a 64 bit interface ID based on the device's MAC address. It basically adds the remaining 16 bits in the middle of the 48 bit MAC address in the form of ff:fe to produce a 64 bit interface ID since the MAC address is only 48 bits.
  - The 7th bit of the client MAC address is reveresed from binary 0 to 1
