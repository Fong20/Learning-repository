...
### Subnetting with a magic number
Number of subnets = 2 power number of subnet bits
the magic number is basically the place value of the last 1 in the subnet mask. Once we get the magic number, the subnets will increment based on the place value.


25th bit represents the subnetting address
