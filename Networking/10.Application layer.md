...
### Presentation layer
- Performs formatting or presenting data to source device in a compatible format
...
### Session layer
- Maintains the communication between two devices
...
### HTTP vs HTTPS
HTTP is not secure as it does not encrypt the data whreas HTTPS is much secure because it encrypts the data during before transmission.
