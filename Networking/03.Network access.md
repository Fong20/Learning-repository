...
**Improtant wireless settings**
Service set identifier (SSID) = Name of the network. It is is case-sensitive, alphanumeric string and supports up to 32 characters.
