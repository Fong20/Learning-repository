...
### Auto-MDIX
With Auto-MDIX, the device is able to detect the type of device connected and determine the type of connection required as well as configure the interface accordingly.
