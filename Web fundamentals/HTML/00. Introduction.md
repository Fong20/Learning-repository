...
## Inserting images
We can insert images by using the image tag and src attribute, The src attribute specifies the path to the image to be displayed

  ### Adjusting the width and height of the image
  We can change the width and height of the image by specifying the width and height attributes. The width  and height attributes are specified in pixels.
