...
6. align-content
  ...
  **Example 5: justify-content set to space-between**
  ...
  - For align-content to work,  more height is required in the flex-container to display the items. It then works on all the items as a set, and dictates what happens with that free space, and the alignment of the entire set of items within it.
  ...
  **Example 1: align-content set to center**
  ![image](https://github.com/Fong20/Learning-repository/assets/150316121/6c68ab3a-7db7-4107-b4b6-72807b2400ea)

  **Example 2: align-content set to flex-start**
  
  When align-content is set to flex-start, the flex items are positioned at the top of the flex-container.
  ![image](https://github.com/Fong20/Learning-repository/assets/150316121/3ac77507-5011-499c-8f88-1e2ade4294a9)

  **Example 3: align-content set to flex-end**
  
  When align-content is set to flex-end, the flex items are positioned at the bottom of the flex-container.
  ![image](https://github.com/Fong20/Learning-repository/assets/150316121/b293933b-284e-43c5-84b5-7f15385e8378)

  **Example 4: align-content set to stretch**
