...
![image](https://github.com/Fong20/Learning-repository/assets/150316121/830cd77e-e75b-4f40-8601-4d2d429703a2
  ...
  - **If both of the operations have the same precedence, then it will look at its asspociativity.** Left to right associativity means it will execute from the left to the right wheras right to left associativity means it will execute from right to left.
