...
```
4. The data points will be grouped to their respective nearest centroid, which is lowest euclidean distance from the point to the centroid

<img width="822" height="436" alt="image" src="https://github.com/user-attachments/assets/4f7ccbf4-01b0-4c65-81a6-ffc3709c1f9c" />

5. calculate the new centroid by calculating the mean of the grouped points and move the centroid to the calculated center. Some of the blue points will turn green now as they are now closer to the green centroid.

<img width="822" height="436" alt="image" src="https://github.com/user-attachments/assets/16207a96-0b16-4ac3-aebd-b4d4d9dff3f8" />

6. repeat the process from step 3 to 5 until the change in centroids is small or there is no linger change in the centroid's position.
