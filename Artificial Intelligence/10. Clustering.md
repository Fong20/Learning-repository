...
5. calculate the new centroid from the grouped points and move the centroid to the calculated center. Some of the blue points will turn green now as they are now closer to the green centroid.
