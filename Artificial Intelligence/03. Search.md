...
- note that the estimated distance is not meant to be accurate
...
- It chooses the neighbor with the lowest heuristic value h(n) and expands on it.
- Once the children nodes are obtained, the heuristic function h(n) is checked again to find the lowest value and expanded again until it reaches the goal

<img width="845" height="456" alt="image" src="https://github.com/user-attachments/assets/889542b2-749a-44ee-b833-1e00f149a235" />
...
**How it works**
- It functions similar to greedy best first search where it chooses the nodes at each of the layer with the lowest straight line distance to the goal and expanding on it. The only difference is there is an addition of the cost from the start node to the current node.

<img width="885" height="478" alt="image" src="https://github.com/user-attachments/assets/3fb364ae-4606-4d39-b95c-a39f095e6c84" />
