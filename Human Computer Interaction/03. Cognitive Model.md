...
- Add plans to the analysis - conditional statements, often utilising boolean logic, e.g. DO 1, THEN 2, THEN (IF condition = true) DO 3, ELSE DO 4, THEN EXIT
- Represent the goals, subgoals, operations and plans using either graphical views (boxes and arrows) or non-graphical methods (e.g. tabulation, outlines,
textual)
...
<img width="814" height="567" alt="Screen Shot 10-14-25 at 08 34 PM" src="https://github.com/user-attachments/assets/803eb905-5a41-4495-8d87-9077188e105e" />
