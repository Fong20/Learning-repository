...
However, it will stop icnreasing the congestion window exponentially once the first packet loss occurs or the cwnd threshold is reached.
  
![image](https://github.com/user-attachments/assets/b2502d63-f18b-4b5c-83d7-3a020430d3aa)

### TCP Congestion control: Congestion avoidance
- 1 RTT = 1 ACK received
- When the congestion window reaches the slow start threshold (ssthresh), congestion window is increased by 1 for every ACK received
