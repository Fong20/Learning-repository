...
![image](https://github.com/Fong20/Learning-repository/assets/150316121/2dc3fbe3-63e0-4246-904e-57ed1e3fe1e7)
  ...
  - It does so by storing the state of the process in the process control block (PCB) so that it can be restored later, and then executes the next trtask in queue.switching from user mode to kernel mode or vice versa.
